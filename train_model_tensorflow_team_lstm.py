...
team_list2019 = pd.read_csv('team_list_scores2019.csv')
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.LSTM(183, input_shape=(X_train.shape[1], X_train.shape[2]), return_sequences=True),
...
model.fit(X_train, y_train, validation_data=(X_test,y_test), steps_per_epoch=100, epochs=20)
